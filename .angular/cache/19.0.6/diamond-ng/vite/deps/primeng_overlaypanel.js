...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(OverlayPanel, {
    className: "OverlayPanel",
    filePath: "overlaypanel.ts",
    lineNumber: 98
  });
})();
...
(function() {
  (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(OverlayPanelModule, {
    declarations: [OverlayPanel],
    imports: [CommonModule, Ripple, SharedModule, TimesIcon],
    exports: [OverlayPanel, SharedModule]
  });
