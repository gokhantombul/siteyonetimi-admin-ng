...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(MeterGroupLabel, {
    className: "MeterGroupLabel",
    filePath: "metergroup.ts",
    lineNumber: 26
  });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(MeterGroup, {
    className: "MeterGroup",
    filePath: "metergroup.ts",
    lineNumber: 96
  });
})();
...
(function() {
  (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(MeterGroupModule, {
    imports: [MeterGroup, SharedModule],
    exports: [MeterGroup, SharedModule]
  });
})();
