...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(InplaceDisplay, {
    className: "InplaceDisplay",
    filePath: "inplace.ts",
    lineNumber: 16
  });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(InplaceContent, {
    className: "InplaceContent",
    filePath: "inplace.ts",
    lineNumber: 24
  });
})();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(Inplace, {
    className: "Inplace",
    filePath: "inplace.ts",
    lineNumber: 57
  });
...
(function() {
  (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(InplaceModule, {
    imports: [Inplace, InplaceContent, InplaceDisplay, SharedModule],
    exports: [Inplace, InplaceContent, InplaceDisplay, SharedModule]
  });
})();
