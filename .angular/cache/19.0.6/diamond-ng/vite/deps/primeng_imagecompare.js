...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(ImageCompare, {
    className: "ImageCompare",
    filePath: "imagecompare.ts",
    lineNumber: 31
  });
})();
...
(function() {
  (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(ImageCompareModule, {
    imports: [ImageCompare, SharedModule],
    exports: [ImageCompare, SharedModule]
  });
})();
